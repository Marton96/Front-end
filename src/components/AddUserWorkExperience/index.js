...
const renderMembers = ({ fields }) => (
  <ul>
    <li>
      <button type="button" onClick={() => fields.push({})}>Add Work Experience</button>
    </li>
...
const FieldArraysForm = (props) => {
  ...
  const onAddFunction = (x) => {
    for (let i = 0; i < x.members.length; i++) {
      ...
      props.onCreateWorkExperience(x.members[i]);
    }
    //
  }
...
export default reduxForm({
  form: 'fieldArrays2',     // a unique identifier for this form
})(FieldArraysForm)